defmodule Phoenix179Web.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(Phoenix179Web.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(Phoenix179Web.Gettext, "errors", msg, opts)
    end
  end
